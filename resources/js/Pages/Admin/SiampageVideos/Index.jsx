...
export default function Index({ videos }) {
    ...
    const destroyVideo = (id) => {
        if (!confirm('Delete this SIAM page video?')) return;
        router.delete(route('admin.siampage-videos.destroy', id));
    };
        ...
        <AuthenticatedLayout
            header={
                <div className="flex items-center justify-between">
                    ...
                    <Link
                        href={route('admin.siampage-videos.create')}
        ...
        >
            ...
            <div className="py-8">
                <div className="mx-auto max-w-7xl space-y-4 sm:px-6 lg:px-8">
                        ...
                        <div className="p-6">
                            {(!videos || videos.length === 0) ? (
                                <div className="text-sm text-gray-600">
                                    No SIAM page videos yet. Click{' '}
                                    <span className="font-semibold">Add Video</span> to create one.
                                </div>
                            ) : (
                                                    ...
                                                    <tr key={v.id} className="align-top">
                                                        ...
                                                        <td className="py-3 pr-4">
                                                            <div className="flex items-center gap-3">
                                                                <Link
                                                                    href={route('admin.siampage-videos.edit', v.id)}
                    ...
                    <div className="text-sm text-gray-600">
                        Public SIAM page will display the latest Active record.
                    </div>
                </div>
            </div>
        </AuthenticatedLayout>
