...
export default function VideoForm({ mode, initialVideo }) {
    ...
    const submit = (e) => {
        ...
        if (mode === 'create') {
            form.post(route('admin.siampage-videos.store'), options);
            return;
        }
        ...
        form
            ...
            .post(route('admin.siampage-videos.update', initialVideo.id), options);
    };
                    ...
                    <div className="rounded-md border border-gray-200 bg-white p-4">
                        ...
                        <div className="mt-4 flex items-center gap-4">
                            ...
                            <div className="text-sm text-gray-600">
                                Used as the poster image for the SIAM page video.
                            </div>
                        </div>
                    </div>
                            ...
                            {localVideoPreviewUrl ? (
                                ...
                                isProbablyEmbedUrl(resolvedExistingVideo) ? (
                                    <div className="aspect-video w-full bg-black text-white/80 flex items-center justify-center text-sm px-4 text-center">
                                        URL preview (YouTube/Vimeo) will be shown on the public page.
                                    </div>
                                ) : (
                                    <video
